...
export const parameters = z.object({
    ...
    include: z
        .string()
        .describe('A comma-separated list of additional fields to include. Accepts the `hasVersions`, `latestVersion`, `latestVersion.content` values.')
        .optional(),
    expand: z
        .string()
...
export async function handler(args, extra) {
    try {
        ...
        if (args.hasVersions !== undefined)
            query.set('hasVersions', String(args.hasVersions));
        if (args.include !== undefined)
            query.set('include', String(args.include));
        if (args.expand !== undefined)
            query.set('expand', String(args.expand));
