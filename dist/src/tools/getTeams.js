...
export async function handler(args, extra) {
    try {
        ...
        if (args.settings !== undefined)
            query.set('settings', String(args.settings));
        if (args.userRoles !== undefined)
            query.set('userRoles', String(args.userRoles));
