...
export const parameters = z.object({
    ...
    collection: z
        ...
        variable: z
            ...
            .describe("A list of the collection's variables to add or update. Secret variables can't be set through this endpoint; manage cloud or vault-backed secrets through environments instead.")
            .optional(),
        auth: z
            .object({
            type: z
        ...
        events: z
            ...
            script: z
                ...
                id: z
                    .string()
                    .describe("The script's ID. You must supply a value (for example, a UUID) when creating or updating collection-level events."),
                type: z
                    .string()
                ...
                .describe('Information about the Javascript code that runs on a collection-level event. Unlike request-level scripts, collection-level scripts require a client-supplied `id` value.')
                .optional(),
        })
        ...
        .describe('The collection updates to apply. You must pass at least one of the following: `info`, `variable`, `auth`, or `events`. Unsupported properties are rejected.\n')
        .optional(),
});
