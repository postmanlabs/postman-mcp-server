...
export const parameters = z.object({
    discoveredServices: z
        ...
        providerServiceId: z
            .string()
            .describe('The ID of the service in the source registry. If you do not pass this property, the system uses the `{name}:{version}` value.')
            .optional(),
        ...
        apiDefinition: z
            ...
            content: z
                .string()
                .describe('A Base64-encoded JSON API definition. Cannot exceed 2 MB after decoding.')
                .optional(),
        })
            .describe('The API definition (specification) for the service. If you pass this with the `endpoints` array, this object is given preference and `endpoints` is ignored.')
            .optional(),
        endpoints: z
            .array(z
            .object({
            ...
            .max(100)
            .describe("A list of the service's endpoints. If you pass this with the `apiDefinition` array, this array is ignored.")
            .optional(),
        tags: z
            .array(z.string())
            .max(50)
