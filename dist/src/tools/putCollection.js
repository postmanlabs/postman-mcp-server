        ...
        item: z.array(z
            ...
            item: z
                ...
                request: z
                    ...
                    .describe('The request definition. Include for request items, omit for folder items.')
                    .optional(),
                item: z
                    .array(z.object({
                    id: z.string().describe("The collection item's ID.").optional(),
                ...
                .describe("A nested collection item — either a request (has 'request') or a folder (has 'item')."))
                .describe("A list of items contained in this folder. Use this property to create folder structures within the collection. Each item can be a request (with a 'request' property) or a nested folder (with its own 'item' property). Omit the 'request' property for folder items.")
                .optional(),
        })
