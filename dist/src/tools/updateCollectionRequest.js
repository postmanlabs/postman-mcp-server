...
export const parameters = z.object({
    ...
    request: requestSchema
        .describe('The full request object following the Postman Collection Format v2.1.0. Includes name, method, URL, headers, body, auth, etc. Only the fields provided will be updated (PATCH behavior).')
        .optional(),
    name: z
        .string()
