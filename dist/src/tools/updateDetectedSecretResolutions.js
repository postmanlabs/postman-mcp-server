...
export async function handler(args, extra) {
    try {
        ...
        if (args.resolution !== undefined)
            bodyPayload.resolution = args.resolution;
        if (args.workspaceId !== undefined)
            bodyPayload.workspaceId = args.workspaceId;
        const options = {
