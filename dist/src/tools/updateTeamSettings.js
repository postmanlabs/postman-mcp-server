...
export const parameters = z.object({
    ...
    settings: z
        ...
        rfa_for_add_collaborator: z
            .enum(['enabled', 'disabled'])
            .describe("If enabled, collaborators require approval before they can access the team's workspaces.")
            .optional(),
    })
...
export async function handler(args, extra) {
    try {
        ...
        if (args.settings !== undefined)
            bodyPayload.settings = args.settings;
        const options = {
