...
// https://www.postman.com/postman/postman-public-workspace/documentation/i2uqzpp/postman-api?entity=request-12959542-f54b8aea-6272-4026-80bd-419732ac0249
...
export const parameters = z.object({
  ...
  request: requestSchema
    .describe(
      'The full request object following the Postman Collection Format v2.1.0. Includes name, method, URL, headers, body, auth, etc.'
    )
    .optional(),
  ...
  name: z
    .string()
    .describe(
      "The request's name (deprecated: use request.name instead). It is recommended that you pass the `name` property. If you do not, the system uses a null value."
    )
    .optional(),
});
...
export async function handler(
  ...
  try {
    ...
    if (args.request !== undefined) {
      ...
      // Backward compatibility: if only name is provided, use it
