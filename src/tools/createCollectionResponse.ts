...
export async function handler(
  ...
  try {
    ...
    if (args.originalRequest !== undefined) bodyPayload.originalRequest = args.originalRequest;
    if (args.responseTime !== undefined) bodyPayload.responseTime = args.responseTime;
    if (args.timings !== undefined) bodyPayload.timings = args.timings;
    if (args.header !== undefined) bodyPayload.header = args.header;
    if (args.cookie !== undefined) bodyPayload.cookie = args.cookie;
    if (args.body !== undefined) bodyPayload.body = args.body;
    if (args.status !== undefined) bodyPayload.status = args.status;
    if (args.code !== undefined) bodyPayload.code = args.code;
    const options: any = {
