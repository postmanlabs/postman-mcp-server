...
export const title = 'Create a collection response';
...
export async function handler(
  ...
  try {
    const endpoint = `/collections/${encodeURIComponent(String(args.collectionId))}/responses`;
    const query = new URLSearchParams();
    if (args.request !== undefined) query.set('request', String(args.request));
    ...
    if (args.headers !== undefined) bodyPayload.headers = args.headers;
    ...
    if (args.time !== undefined) bodyPayload.time = args.time;
    if (args.cookies !== undefined) bodyPayload.cookies = args.cookies;
    if (args.mime !== undefined) bodyPayload.mime = args.mime;
    if (args.text !== undefined) bodyPayload.text = args.text;
    if (args.language !== undefined) bodyPayload.language = args.language;
    if (args.rawDataType !== undefined) bodyPayload.rawDataType = args.rawDataType;
    if (args.requestObject !== undefined) bodyPayload.requestObject = args.requestObject;
    const options: any = {
