...
export async function handler(
  ...
  try {
    ...
    if (args.repositoryUrl !== undefined) bodyPayload.repositoryUrl = args.repositoryUrl;
    if (args.targetBranch !== undefined) bodyPayload.targetBranch = args.targetBranch;
