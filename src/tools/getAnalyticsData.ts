...
export async function handler(
  ...
  try {
    ...
    if (args.resource !== undefined) query.set('resource', String(args.resource));
    if (args.metrics !== undefined) query.set('metrics', String(args.metrics));
    if (args.view !== undefined) query.set('view', String(args.view));
    if (args.workspaceType !== undefined) query.set('workspaceType', String(args.workspaceType));
    if (args.userId !== undefined) query.set('userId', String(args.userId));
    if (args.duration !== undefined) query.set('duration', String(args.duration));
    if (args.requestId !== undefined) query.set('requestId', String(args.requestId));
    if (args.responseStatus !== undefined) query.set('responseStatus', String(args.responseStatus));
    if (args.attentionType !== undefined) query.set('attentionType', String(args.attentionType));
    if (args.period !== undefined) query.set('period', String(args.period));
    if (args.userType !== undefined) query.set('userType', String(args.userType));
