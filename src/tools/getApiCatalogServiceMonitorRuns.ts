...
export const parameters = z.object({
  ...
  sort: z
    ...
    .describe(
      'Sort the results in field:direction order format. Accepts the `timestamp`, `duration`, and `failedAssertions` fields. Supports the `asc` and `desc` directions.'
    )
    .optional(),
  environmentId: z
    .string()
