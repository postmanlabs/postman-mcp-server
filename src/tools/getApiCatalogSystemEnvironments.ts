...
export const parameters = z.object({
  isProduction: z
    .boolean()
    .describe(
      'If true, filters the response results to return only system environments marked as production.'
    )
    .optional(),
  limit: z
    .number()
...
export async function handler(
  ...
  try {
    ...
    if (args.isProduction !== undefined) query.set('isProduction', String(args.isProduction));
