      ...
      orgs: z
        .object({
          '{{orgId}}': z
            ...
            .describe(
              "A list of the organization's roles. The array's name is the organization's ID."
            )
            .optional(),
        })
...
export async function handler(
  ...
  try {
    ...
    if (args.add !== undefined) bodyPayload.add = args.add;
    if (args.remove !== undefined) bodyPayload.remove = args.remove;
    const options: any = {
