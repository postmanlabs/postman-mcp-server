...
export async function handler(
  ...
  try {
    ...
    if (args.topic !== undefined) bodyPayload.topic = args.topic;
    if (args.category !== undefined) bodyPayload.category = args.category;
    if (args.isPinned !== undefined) bodyPayload.isPinned = args.isPinned;
    if (args.relatedResources !== undefined) bodyPayload.relatedResources = args.relatedResources;
    const options: any = {
