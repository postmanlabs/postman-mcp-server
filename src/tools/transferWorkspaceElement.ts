...
export async function handler(
  ...
  try {
    ...
    if (args.id !== undefined) bodyPayload.id = args.id;
    if (args.type !== undefined) bodyPayload.type = args.type;
    if (args.to !== undefined) bodyPayload.to = args.to;
    const options: any = {
