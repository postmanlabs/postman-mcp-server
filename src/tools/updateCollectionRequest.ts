...
const requestAuthSchema = z.array(
  z
    .object({
...
// Request schema matching Postman Collection documentation:
// https://www.postman.com/postman/postman-public-workspace/documentation/i2uqzpp/postman-api?entity=request-12959542-470056b2-9bf0-4c29-aaf2-81cdcee2310b
const requestSchema = z
  .object({
    ...
    rawModeData: z
      .string()
      .describe(
        'If the `dataMode` value is `raw` or `binary`, the raw content of the request body.'
      )
      .optional()
      .nullable(),
    graphqlModeData: z
    ...
    auth: z
      .object({
        ...
        digest: requestAuthSchema
          .describe(
            'The attributes for [Digest Auth](https://learning.postman.com/docs/sending-requests/authorization/digest-auth/).'
          )
          .optional(),
        ...
        hawk: requestAuthSchema
          .describe(
            'The attributes for [Hawk](https://learning.postman.com/docs/sending-requests/authorization/hawk-authentication/).'
          )
          .optional(),
        awsv4: requestAuthSchema
          .describe(
            'The attributes for [AWS V4](https://learning.postman.com/docs/sending-requests/authorization/aws-signature/).'
          )
          .optional(),
        ntlm: requestAuthSchema
          .describe(
            'The attributes for [NTLM](https://learning.postman.com/docs/sending-requests/authorization/ntlm-authentication/).'
          )
          .optional(),
        edgegrid: requestAuthSchema
          .describe(
            'The attributes for [Edgegrid](https://learning.postman.com/docs/sending-requests/authorization/akamai-edgegrid/).'
          )
          .optional(),
        jwt: requestAuthSchema
          .describe(
            'The attributes for [JWT](https://learning.postman.com/docs/sending-requests/authorization/authorization-types/#jwt).'
          )
          .optional(),
        asap: requestAuthSchema
          .describe(
            'The attributes for [ASAP](https://learning.postman.com/docs/sending-requests/authorization/atlassian/).'
          )
          .optional(),
      })
      .passthrough()
...
export const parameters = z.object({
  ...
  request: requestSchema
    .describe(
      'The full request object following the Postman Collection Format v2.1.0. Includes name, method, URL, headers, body, auth, etc. Only the fields provided will be updated (PATCH behavior).'
    )
    .optional(),
  name: z
    .string()
    .describe("The request's name (deprecated: use request.name instead).")
    .optional(),
  method: z
    .enum([
      'GET',
    ...
    .describe("The request's method (deprecated: use request.method instead).")
    .optional(),
});
...
export async function handler(
  ...
  try {
    ...
    // If a full request object is provided, use it
    if (args.request !== undefined) {
      Object.assign(bodyPayload, args.request);
    } else {
      // Backward compatibility: if individual fields are provided, use them
